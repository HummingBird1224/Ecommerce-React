			...
			>
				...
				<DialogContent>
					<DialogContentText id="alert-dialog-description">
						You are about to place a bid of amount {Intl.NumberFormat("en", { style: "currency", currency: "₹" }).format(bidValue) }. Please verify the amount before submitting. You may have to contact the seller through customer support to undo this action.
					</DialogContentText>
				</DialogContent>
				<DialogActions>
			...
			<Grid item container justifyContent={"center"} mt={2}>
				<Grid item xs={12}>
					<Typography variant={"h6"} color={"green"} fontWeight={"bold"}>
								Last bid : {Intl.NumberFormat("en", { style: "currency", currency: "₹" }).format(lastBid) }
					</Typography>
				</Grid>
			</Grid>
			<Grid item  container justifyContent={"center"} mt={2}>
				<Grid item xs={12}>
					<Typography variant={"h7"}  fontWeight={"bold"}>
								Starting bid : {Intl.NumberFormat("en", { style: "currency", currency: "₹" }).format(minimumBid) }
					</Typography>
				</Grid>
			</Grid>
			{props.user==1?
